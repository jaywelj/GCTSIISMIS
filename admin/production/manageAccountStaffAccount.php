				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Manage Staff Accounts<small></small></h3>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>Accounts <small>Staff</small></h2>
									<ul class="nav navbar-right">
										<button class="btn btn-default btn-info" data-toggle="modal" data-target="#add_data_Modal" type="button">ADD ANOTHER STAFF</button>
									</ul>
											...
											{  
												...
												<tr>
													<td>
														...
														<a title="Delete" class="btn btn-danger" href="manageAccountStudentAccountDelete.php?id=<?php echo $row['adminUserName']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
													...
													<td> <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['adminImage'] ).'"width="50" />';?> </td>
												</tr>  
												<?php
											}
											?> 
					...
					// checking empty fields
						...
						//insert data to database   
								...
								if (!empty($VarcharAdminAccountImage)) {
									$queryAdd = "INSERT INTO `tbl_adminaccount` (`adminUserName`, `adminFirstName`, `adminMiddleName`, `adminLastName`, `adminBirthDate`, `adminPassword`, `adminImage`, `adminAccessLevel`) VALUES ('$VarcharAdminAccountUsername', '$VarcharAdminAccountFirstName', '$VarcharAdminAccountMiddleName', '$VarcharAdminAccountLastName', '$VarcharAdminAccountBirthdate', '$VarcharAdminAccountPassword', '$VarcharAdminAccountImage', 'Staff')";
								}
								else{
									$queryAdd = "INSERT INTO `tbl_adminaccount` (`adminUserName`, `adminFirstName`, `adminMiddleName`, `adminLastName`, `adminBirthDate`, `adminPassword`, `adminImage`, `adminAccessLevel`) VALUES ('$VarcharAdminAccountUsername', '$VarcharAdminAccountFirstName', '$VarcharAdminAccountMiddleName', '$VarcharAdminAccountLastName', '$VarcharAdminAccountBirthdate', '$VarcharAdminAccountPassword', NULL, 'Staff')";
								}
