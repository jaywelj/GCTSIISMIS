							...
							<div class="x_panel">
								<div class="x_title">
									...
									<ul class="nav navbar-right">
										<button class="btn btn-default btn-info" data-toggle="modal" data-target="#add_data_Modal" type="button">ADD ANOTHER COURSE</button>
									</ul>
									<div class="clearfix"></div>
								</div>
								<div class="x_content">
			...
			<div id="add_data_Modal" class="modal fade">
				...
				// for method 1/
							...
							<form method="post" id="insert_form" enctype="multipart/form-data">
								...
								<br />
								<input type="submit" name="btnAdd" id="btnAdd" value="Add Course" class="btn btn-success pull-right" />
							</form>
