...
//Get Personal Information
	...
	if ($varcharSexuality == 'Others') {
		$varcharSexuality = mysqli_real_escape_string($connect, $_POST['txtbxOthersSexuality']);
	}
	...
	if ($varcharCivilStatus == 'Others') {
		$varcharCivilStatus = mysqli_real_escape_string($connect, $_POST['txtbxOthersCivilStatus']);
	}
	...
	$varcharEmailAddress = mysqli_real_escape_string($connect, $_POST['txtbxEmailAddress']);
...
//Interest and Hoobies
	...
	$varcharFavoriteSubject = mysqli_real_escape_string($connect, $_POST['txtareaFavoriteSubject']);
	$varcharLeastFavoriteSubject = mysqli_real_escape_string($connect, $_POST['txtareaLeastFavoriteSubject']);
	$varcharHobby1 = mysqli_real_escape_string($connect, $_POST['txtbxHobby1']);
	$varcharHobby2 = mysqli_real_escape_string($connect, $_POST['txtbxHobby2']);
	$varcharHobby3 = mysqli_real_escape_string($connect, $_POST['txtbxHobby3']);
	$varcharHobby4 = mysqli_real_escape_string($connect, $_POST['txtbxHobby4']);
	...
	if (isset($_POST['checkOrganizationInterestNoInterest'])) {
		...
		if (isset($_POST['checkOrganizationInterest'])) {
			$varcharOrganizationInterestArray = mysqli_real_escape_string($connect, $_POST['checkOrganizationInterest'];
