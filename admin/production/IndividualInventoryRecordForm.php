...
//Get Personal Information
	$varcharFirstName = mysqli_real_escape_string($connect,$_POST['txtbxFirstName']);
	$varcharMiddleName = mysqli_real_escape_string($connect,$_POST['txtbxMiddleName']);
	$varcharLastName = mysqli_real_escape_string($connect,$_POST['txtbxLastName']);
	$varcharGender = mysqli_real_escape_string($connect,$_POST['radioGender']);
	$varcharSexuality = mysqli_real_escape_string($connect,$_POST['dropdownSexuality']);
	$varcharOthersSexuality = mysqli_real_escape_string($connect,$_POST['']);
	if($varcharSexuality == 'Others')
	{
		$varcharSexuality = $varcharOthersSexuality;
	}
	$intAge = mysqli_real_escape_string($connect,$_POST['txtbxAge']);
	$dateDateOfBirth = mysqli_real_escape_string($connect,$_POST['dateDateOfBirth']);
	$varcharPlaceOfBirth = mysqli_real_escape_string($connect,$_POST['txtbxPlaceOfBirth']);
	$varcharCivilStatus = mysqli_real_escape_string($connect,$_POST['dropdownCivilStatus']);
	$varcharOthersCivilStatus = mysqli_real_escape_string($connect,$_POST['txtbxOthersCivilStatus']);
	if($varcharCivilStatus == 'Others')
	{
		$varcharCivilStatus = $varcharOthersCivilStatus;
	}
	$varcharReligion = mysqli_real_escape_string($connect,$_POST['dropdownReligion']);
	$varcharOthersReligion = mysqli_real_escape_string($connect,$_POST['txtbxOthersReligion']);
	if($varcharReligion == 'Others')
	{
		$varcharReligion = $varcharOthersReligion;
	}
	$doubleHeight = mysqli_real_escape_string($connect,$_POST['txtbxHeight']);
	$doubleWeight = mysqli_real_escape_string($connect,$_POST['txtbxWeight']);
	$varcharComplexion = mysqli_real_escape_string($connect,$_POST['dropdownComplexion']);
	if($varcharComplexion == 'Others')
	{
		$varcharComplexion == mysqli_real_escape_string($connect,$_POST['txtbxOthersComplexion']);
	}
	$varcharYear = mysqli_real_escape_string($connect,$_POST['txtbxYear']);
	$varcharSection = mysqli_real_escape_string($connect,$_POST['txtbxSection']);
	$varcharCityAddress = mysqli_real_escape_string($connect,$_POST['dropdownCityAddress']);
	$varcharProvincialAddress = mysqli_real_escape_string($connect,$_POST['dropdownProvincialAddress']);
	$vacharEmailAddress = mysqli_real_escape_string($connect,$_POST['txtbxEmailAddress']);
//End of Personal Info
//Educational Background
	$varcahrPreELemSchoolGraduated=mysqli_real_escape_string($connect,$_POST['txtbxPreElemSchoolGraduated']);
	$varcahrPreELemSchoolAddress=mysqli_real_escape_string($connect,$_POST['txtbxPreElemSchoolAddress']);

	$varcahrPreElemYearAttended=mysqli_real_escape_string($connect,$_POST['txtbxPreElemYearAttended']);
	$varcharPreElemHonors=mysqli_real_escape_string($connect,$_POST['txtbxPreElemHonors']);
	$varcharElementarySchoolGraduated=mysqli_real_escape_string($connect,$_POST['txtbxElementarySchoolGraduated']);
	$varcharElementarySchoolAddress=mysqli_real_escape_string($connect,$_POST['txtbxElementarySchoolAddress']);
	$varcahrElementaryYearAttended=mysqli_real_escape_string($connect,$_POST['txtbxElementaryYearAttended']);
	$varcharElementaryHonors=mysqli_real_escape_string($connect,$_POST['txtbxElementaryHonors']);
	$varcharHighschoolSchoolGraduated=mysqli_real_escape_string($connect,$_POST['txtbxHighschoolSchoolGraduated']);
	$varcharHighschoolSchoolAddress=mysqli_real_escape_string($connect,$_POST['txtbxHighschoolSchoolAddress']);
	$varcharHighschoolYearAttended=mysqli_real_escape_string($connect,$_POST['txtbxHighschoolYearAttended']);
	$varcharHighschoolHonors=mysqli_real_escape_string($connect,$_POST['txtbxHighschoolHonors']);
	$varcharVocationalSchoolGraduated=mysqli_real_escape_string($connect,$_POST['txtbxVocationalSchoolGraduated']);
	$varcharVocationalSchoolAddress=mysqli_real_escape_string($connect,$_POST['txtbxVocationalSchoolAddress']);
	$varcharVocationalYearAttended=mysqli_real_escape_string($connect,$_POST['txtbxVocationalYearAttended']);
	$varcharVocationalHonors=mysqli_real_escape_string($connect,$_POST['txtbxVocationalHonors']);
	$varcharCollegeSchoolGraduated=mysqli_real_escape_string($connect,$_POST['txtbxCollegeSchoolGraduated']);
	$varcharCollegeSchoolAddress=mysqli_real_escape_string($connect,$_POST['txtbxCollegeSchoolAddress']);
	$varcharCollegeYearAttended=mysqli_real_escape_string($connect,$_POST['txtbxCollegeYearAttended']);
	$varcharCollegeHonors=mysqli_real_escape_string($connect,$_POST['txtbxCollegeHonors']);
//End of Educational Background
//Family Background
	$varcharMotherName = mysqli_real_escape_string($connect,$_POST['txtbxMotherName']);
	$varcharMotherAge = mysqli_real_escape_string($connect,$_POST['txtbxMotherAge']);
	$varcharMotherEducationalAttainment = mysqli_real_escape_string($connect,$_POST['dropdownMotherEducationalAttainment']);
	$varcharMotherOccupationType = mysqli_real_escape_string($connect,$_POST['dropdownMotherOccupationType']);
	$varcharOccupation = mysqli_real_escape_string($connect,$_POST['txtbxMotherOccupation']);
	$varcharMotherNameOfEmployer = mysqli_real_escape_string($connect,$_POST['txtbxMotherNameOfEmployer']);
	$varcharMotherAddressOfEmployer = mysqli_real_escape_string($connect,$_POST['txtbxMotherAddressOfEmployer']);
	$varcharFatherName = mysqli_real_escape_string($connect,$_POST['txtbxFatherName']);
	$varcharFatherAge = mysqli_real_escape_string($connect,$_POST['txtbxFatherAge']);
	$varcharGuardianRelationship = mysqli_real_escape_string($connect,$_POST['dropdownGuardianRelationship']);
	$varcharFatherEducationalAttainment = mysqli_real_escape_string($connect,$_POST['dropdownFatherEducationalAttainment']);
	$varcharFatherOccupationType = mysqli_real_escape_string($connect,$_POST['dropdownFatherOccupationType']);
	$varcharFatherOccupation = mysqli_real_escape_string($connect,$_POST['txtbxFatherOccupation']);
	$varcharFatherNameOfEmployer = mysqli_real_escape_string($connect,$_POST['txtbxFatherNameOfEmployer']);
	$varcharFatherAddressOfEmployer = mysqli_real_escape_string($connect,$_POST['txtbxFatherAddressOfEmployer']);
	$varcharGuardianName = mysqli_real_escape_string($connect,$_POST['txtbxGuardianName']);
	$varcharGuardianAge = mysqli_real_escape_string($connect,$_POST['txtbxGuardianAge']);
	$varcharGuardianEducationalAttainment = mysqli_real_escape_string($connect,$_POST['dropdownGuardianEducationalAttainment']);
	$varcharGuardianOccupationType = mysqli_real_escape_string($connect,$_POST['dropdownGuardianOccupationType']);
	$varcharGuardianOccupation = mysqli_real_escape_string($connect,$_POST['txtbxGuardianOccupation']);
	$varcharGuardianNameOfEmployer = mysqli_real_escape_string($connect,$_POST['txtbxGuardianNameOfEmployer']);
	$varcharGuardianAddressOfEmployer = mysqli_real_escape_string($connect,$_POST['txtbxGuardianAddressOfEmployer']);
	$varcharParentsMaritalRelationship = mysqli_real_escape_string($connect,$_POST['dropdownParentsMaritalRelationship']);
	$varcharNoOfChildrenInTheFamily = mysqli_real_escape_string($connect,$_POST['txtbxNoOfChildrenInTheFamily']);
	$varcharNoOfBrothers = mysqli_real_escape_string($connect,$_POST['txtbxNoOfBrothers']);
	$varcharNoOfSisters = mysqli_real_escape_string($connect,$_POST['txtbxNoOfSisters']);
	$varcharNoOfBrothersSistersGainfullyEmployed = mysqli_real_escape_string($connect,$_POST['txtbxNoOfBrothersSistersGainfullyEmployed']);
	$varcharOrdinalPosition = mysqli_real_escape_string($connect,$_POST['dropdownOrdinalPosition']);
	$varcharWhoFinancesYoureSchooling = mysqli_real_escape_string($connect,$_POST['dropdownWhoFinancesYourSchooling']);
	$varcharNatureOfResidence = mysqli_real_escape_string($connect,$_POST['dropdownNatureOfResidence']); 
	$varcharWithWhom = mysqli_real_escape_string($connect,$_POST['txtbxWithWhom']);
	$doubleWeeklyAllowance = mysqli_real_escape_string($connect,$_POST['txtbxWeeklyAllowance']);
//End Of Family Background
//Health Background
	$varcharVisionProblem = mysqli_real_escape_string($connect,$_POST['radioVision']);
	if($varcharVisionProblem == "Yes")
	{
		$varcharVisionProblem = mysqli_real_escape_string($connect,$_POST['txtbxVision']);
	}
	$varcharHearingProblem = mysqli_real_escape_string($connect,$_POST['radioHearing']);
	if($varcharHearingProblem == "Yes")
	{
		$varcharHearingProblem = mysqli_real_escape_string($connect,$_POST['txtbxHearing']);
	}
	$varcharSpeachProblem = mysqli_real_escape_string($connect,$_POST['radioSpeach']);
	if($varcharSpeachProblem == "Yes")
	{
		$varcharSpeachProblem = mysqli_real_escape_string($connect,$_POST['txtbxSpeach']);
	}
	$varcharGeneralHealthProblem = mysqli_real_escape_string($connect,$_POST['radioGeneralHealth']);
	if($varcharGeneralHealthProblem == "Yes")
	{
		$varcharGeneralHealthProblem = mysqli_real_escape_string($connect,$_POST['txtbxGeneralHealth']);
	}

	$varcharPyschiatristConsult = mysqli_real_escape_string($connect,$_POST['radioPsychiatrist']);
	if($varcharPyschiatristConsult == "Yes")
	{
		$datePsychiatristWhen = mysqli_real_escape_string($connect,$_POST['datePsychiatrist']);
		$varcharPyschiatristReason = mysqli_real_escape_string($connect,$_POST['txtareaForWhatPsychiatrist']);
	}
	else
	{
	...
	$varcharPyschologistConsult = mysqli_real_escape_string($connect,$_POST['radioPsychologist']);

	if($varcharPyschologistConsult == "Yes")
	{
		$datePsychologistWhen = mysqli_real_escape_string($connect,$_POST['datePsychologist']);
		$varcharPyschologistReason = mysqli_real_escape_string($connect,$_POST['txtareaForWhatPsychologist']);
	}
	else
	{
	...
	$varcharCounselorConsult = mysqli_real_escape_string($connect,$_POST['radioCounselor']);

	if($varcharCounselorConsult == "Yes")
	{
		$dateCounselorWhen = mysqli_real_escape_string($connect,$_POST['datePsychiatrist']);
		$varcharCounselorReason = mysqli_real_escape_string($connect,$_POST['txtareaForWhatCounselor']);
	}
	else
	{
...
//Interest and Hoobies
	...
	$varcharLeastFavoriteSubject = $_POST['txtareaLeastFavoriteSubject']);
	$varcharHobby1 = $_POST['txtbxHobby1']);
	$varcharHobby2 = $_POST['txtbxHobby2']);
	$varcharHobby3 = $_POST['txtbxHobby3']);
	$varcharHobby4 = $_POST['txtbxHobby4']);
...
//End Of Interest and Hobbies
	...
	echo "<script type='text/javascript'>alert('$varcharOrganizationInterest');</script>";
											...
											<div class="form-horizontal form-label-left">
												...
												<div class="x_panel ">
													...
													<div class="form-group ">
														...
														<div class="col-md-6 col-sm-6">
															<input id="dateTestResultDate[]" name="dateTestResultDate[]" value="" class="date-picker form-control col-md-7 col-xs-12" type="date">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6">
															<input id="txtbxTestResultName[]" name="txtbxTestResultName[]" value="" type="text" class="form-control col-md-7 col-xs-12">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6">
															<input id="txtbxTestResultRawScore[]" name="txtbxTestResultRawScore[]" value="" type="text" class="form-control col-md-7 col-xs-12">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6">
															<input id="txtbxTestResultPercentileRating[]" name="txtbxTestResultPercentileRating[]" value="" type="text" class="form-control col-md-7 col-xs-12">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6">
															<textarea class="form-control" name="txtareaTestResultDescription[]" id="txtareaTestResultDescription[]" required=""></textarea>
														</div>
													</div>
												</div>
												<!--NEW FIELDS HERE-->
