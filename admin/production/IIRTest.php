...
if (isset($_POST['btnSubmit']))
{
		...
		for($i=0;$i<=count($_POST['txtbxTestResultNameInitial']);$i++){
			...
			echo "Test Date "; echo $_POST['dateTestResultDateInitial'][$i]; echo"<br>";
			echo "Test Name ";echo $_POST['txtbxTestResultNameInitial'][$i]; echo"<br>";
			echo "Test RS ";echo $_POST['txtbxTestResultRawScoreInitial'][$i]; echo"<br>";
			echo "Test PR ";echo $_POST['txtbxTestResultPercentileRatingInitial'][$i]; echo"<br>";
			echo "Test Description ";echo $_POST['txtareaTestResultDescriptionInitial'][$i]; echo"<br>";
			echo "Test ID ";echo $_POST['hiddenTestID'][$i]; echo"<br>";


			$InsertingTestResultDate = $_POST['dateTestResultDateInitial'][$i];
			$InsertingTestResultName = $_POST['txtbxTestResultNameInitial'][$i];
			$InsertingTestRS = $_POST['txtbxTestResultRawScoreInitial'][$i];
			$InsertingTestPR = $_POST['txtbxTestResultPercentileRatingInitial'][$i];
			$InsertingTestResultDescription = $_POST['txtareaTestResultDescriptionInitial'][$i];
   ...
   //                          						//redirectig to the display page. In our case, it is index.php
			...
			$message = $_POST['txtbxTestResultNameInitial'][$i];
			echo "<script type='text/javascript'>alert('$message');</script>";
...
{	
	...
	{ 
		...
		else
		{
			...
			echo "<script type='text/javascript'>alert('$message');</script>";
                            						//redirectig to the display page. In our case, it is index.php
			echo "<script type='text/javascript'>location.href = 'IIRTest.php?id=$VarcharStudentNumber';</script>";
		}
													...
													<div class="form-group">
														...
														<div class="col-md-2 col-sm-2 col-xs-6">
															<select class="select2_single form-control" tabindex="-1" name="dropdownContactPersonRelationship" id="dropdownContactPersonRelationship">
																<option></option>_real_escape_string($connect, $_POST['dropdownstudentGuardianRelation']);
																<option selected=""></option>
											...
											<div class="tab-pane" role="tabpanel" id="complete">
												...
												<div class="form-horizontal form-label-left">
													...
													<div class="form-group">
														...
														<input type="hidden" id="hiddenTestID" name="hiddenTestID[]" value="'.$resu['testID'].'">
													</div>
												</div>';
