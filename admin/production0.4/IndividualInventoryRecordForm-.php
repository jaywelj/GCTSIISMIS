                        ...
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input value="Jaywel" type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="last-name2" name="last-name" required="required" class="form-control col-md-7 col-xs-12"  value="Javier">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3" >Middle Name / Initial</label>
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="Bisarra">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected="selected" value="public">Homosexual</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2">
                              <input value = "19" id ="age" class="form-control col-md-7 col-xs-12" type="text" name="age">
                            </div>
                            <label class="control-label col-md-1 col-sm-1">Date Of Birth </label>
                            <div class="col-md-3 col-sm-3">
                              <input value = "1998-07-18" id="birthday2" class="date-picker form-control col-md-7 col-xs-12" required="required" type="date">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Place of Birth</label>
                            <div class="col-md-6 col-sm-6">
                              <input value = "Taytay, Rizal" id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2">
                              <select class="select2_single form-control" tabindex="-1">
                                <option></option>
                                <option disabled="" selected=""></option>
                                <option selected value="public">Single</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="public">Catholic</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2">
                              <input value = "170" id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name">
                            </div>
                            <label for="middle-name" class="control-label col-md-1 col-sm-1">Weight</label>
                            <div class="col-md-2 col-sm-2">
                              <input value = "56" id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="public">Fair Skin</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input disabled="disabled" id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2015-04778-MN-0">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="3">
                            </div>
                            <label for="middle-name" class="control-label col-md-1 col-sm-1">Section</label>
                            <div class="col-md-3 col-sm-3">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Student Type</label>
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1" disabled="disabled">
                                <option></option>
                                <option disabled="" selected=""></option>
                                <option value="public">Laboratory High School</option>
                                <option value="public">Senior High School</option>
                                <option selected value="public">College</option>
                                <option value="public">Graduate School</option>
                                <option value="public">Open University</option>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="88">Metro Manila~Manila</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="36421">Rizal</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="jaywelbissara@gmail.com">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Mobile No.</label>
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="09763276371">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Telephone No.</label>
                            <div class="col-md-6 col-sm-6">
                      ...
                      <div id="step-2">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Taytay Primary School">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="last-name2" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="Taytay,Rizal">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2004-2005">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Honors Recieved/Special Awards</label>
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="None">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Taytay Elementary School">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="last-name">School Address <span class="required">*</span>
                          ...
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Year Attended</label>
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2005-2010">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Honors Recieved/Special Awards</label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Taytay High School">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="last-name">School Address <span class="required">*</span>
                          ...
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Year Attended</label>
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2008-2011">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">Honors Recieved/Special Awards</label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="98.99">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3">
                              <div id="gender2" class="btn-group" data-toggle="buttons" >
                                <label class="btn btn-primary" data-toggle-class="btn-primary " style="padding-left: 22px; padding-right:22px;" data-toggle-passive-class="btn-default">
                      ...
                      <div id="step-3">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Mama Javier">
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="45">
                            </div>
                            <div id="gender2" class="btn-group" data-toggle="buttons">
                              <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="public">College undergraduate</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Papa Javier">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="first-name">Age <span class="required">*</span>
                            ...
                            <div class="col-md-3 col-sm-3">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="50">
                            </div>
                            <div id="gender2" class="btn-group" data-toggle="buttons">
                              <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                <input selected type="radio" name="gender" value="male"> Living 
                              </label>
                              <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                <input type="radio" name="gender" value="female" checked=""> Deceased
                              </label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Business Man">
                            </div>
                          </div> 
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="first-name">Name of Employer <span class="required">*</span>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                <option></option>
                                <option disabled="" selected=""></option>
                                <option selected value="public">Parent</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                <option></option>
                                <option disabled="" selected=""></option>
                                  <option selected value="public">Married and staying together</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2">
                              <input id="middle-name2" class="form-control col-md-1 col-xs-1" type="text" name="middle-name" value="2">
                            </div>
                            <label for="middle-name" class="control-label col-md-1 col-sm-1">Brothers</label>
                            <div class="col-md-1 col-sm-1">
                              <input id="middle-name2" class="form-control col-md-1 col-xs-1" type="text" name="middle-name" value="1">
                            </div>
                            <label for="middle-name" class="control-label col-md-1 col-sm-1">Sisters</label>
                            <div class="col-md-1 col-sm-1">
                              <input id="middle-name2" class="form-control col-md-1 col-xs-1" type="text" name="middle-name" value="0">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="public">Second</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <div id="gender2" class="btn-group" data-toggle="buttons">
                                <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                  <input type="radio" name="gender" value="male"> Family 
                                </label>
                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                  <input type="radio" name="gender" value="female" checked=""> Your studies
                                </label>
                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                  <input type="radio" name="gender" value="female" checked=""> His/Her own family
                                </label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                <option></option>
                                <option disabled="" selected=""></option>
                                <option selected value="public">Parents</option>
                                <option value="public">Brother/Sister</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="last-name2" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="1000">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                ...
                                <option selected value="public">10,001 - 15,000</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="last-name2" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="Dorm mates">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1">
                                <option disabled="" selected=""></option>
                                  ...
                                  <option selected value="public">Bed spacer</option>
                      ...
                      <div id="step-5">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <textarea id="message" required="required" class="form-control" name="message" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="150" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                            data-parsley-validation-threshold="10">Logic,Programming</textarea>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <textarea id="message" required="required" class="form-control" name="message" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="150" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                            data-parsley-validation-threshold="10">Trigonometry</textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Programming">
                            </div>
                          </div><div class="form-group">
                            <label class="control-label col-md-3 col-sm-3" for="first-name">2. <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Computer Games">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="ROS">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Organizationof your interest<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6">
                              <select class="select2_single form-control" tabindex="-1">
                                <option></option>
                                <option disabled="" selected=""></option>
