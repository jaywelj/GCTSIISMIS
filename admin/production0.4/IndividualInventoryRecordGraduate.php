          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Graduate School<small>Users</small></h2>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            ...
                            <div class="btn-group  btn-group-sm" >
                              <a href="individualInventoryRecordForm.php" class="btn btn-success btn-sm "><i class="fa fa-edit"></i></a>
                            </div>
                            <div class="btn-group  btn-group-sm" >
                              <a href="individualInventoryRecordForm.php" class="btn btn-info btn-sm "><i class="fa fa-list"></i></a>
                            </div>
                          </td>                         
