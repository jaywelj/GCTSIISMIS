                                ...
                                {  
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a title="Delete" class="btn btn-danger" href="manageAccountAdminAccountDelete.php?id=<?php echo $row['adminUserName']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
