                        ...
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="first-name2" required="required" class="form-control col-md-7 col-xs-12" value="Rona May">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="last-name2" name="last-name" required="required" class="form-control col-md-7 col-xs-12"  value="De Juan">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3" >Middle Name / Initial</label>
                            <div class="col-md-6 col-sm-6">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="Zamoras">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input disabled="disabled" id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2015-02775-MN-0">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3">
                              <input id="middle-name2" class="form-control col-md-7 col-xs-12" type="text" name="middle-name" value="2D">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <select class="select2_single form-control" tabindex="-1" disabled="disabled">
                                ...
                                <option selected value="Collge">College</option>
