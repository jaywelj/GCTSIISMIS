          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="StudentAccount-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" height="50px" width="50px" alt="">John Doe
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-StudentAccountmenu pull-right">
              ...
              <?php
                if(isset($_POST['btnAdd'])) 
                {
                    ...
                    { 
                        ...
                        $queryAdd = "INSERT INTO `tbl_studentaccount` (`studentNumber`, `studentFirstName`, `studentMiddleName`, `studentLastName`, `studentPassword`, `aboutStudent`, `studentDisplayPic`, `studentCoverPhoto`) VALUES ('$VarcharStudentAccountNumber', '$VarcharStudentAccountFirstName', '$VarcharStudentAccountMiddleName', '$VarcharStudentAccountLastName', '$VarcharStudentAccountPassword', NULL, NULL, NULL)";

                        $queryAdd2 = "INSERT INTO `tbl_personalinfo` (`infoID`, `lastName`, `firstName`, `middleName`, `sex`, `sexuality`, `age`, `course`, `year`, `section`, `civilStatus`, `birthDate`, `height`, `weight`, `complexion`, `birthPlace`, `cityAddress`, `provincialAddress`, `telNumber`, `mobileNumber`, `hsGWA`, `religion`, `employerName`, `employerAddress`, `contactPersonName`, `cpAddress`, `cpRelationship`, `cpContactNumber`, `collegeCode`, `courseCode`, `studentNumber`) VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '$VarcharStudentAccountYear', '$VarcharStudentAccountSection', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'CCIS', '$VarcharStudentAccountCourse', '$VarcharStudentAccountNumber')";
