          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Laboratory High School<small>Users</small></h2>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            <a href="individualInventoryRecordForm.php" class="btn btn-primary btn-sm "><i class="fa fa-pencil"></i></a>
                            </div>
                              
                            <div class="btn-group  btn-group-sm" >
                              <a href="individualInventoryRecordView.php" class="btn btn-info btn-sm "><i class="fa fa-list"></i></a>
                            </div>
                          </td>                        
                        ...
                        <tr>
                          <td>
                            <div class="btn-group  btn-group-sm" >
                            <a href="individualInventoryRecordForm2.php" class="btn btn-primary btn-sm "><i class="fa fa-pencil"></i></a>
                            </div>
                        ...
                        <tr>
                          <td>
                            <div class="btn-group  btn-group-sm" >
                            <a href="individualInventoryRecordForm.php" class="btn btn-warning btn-sm "><i class="fa fa-pencil"></i></a>
                            </div>
                            <div class="btn-group  btn-group-sm" >
                              <button class="btn btn-default btn-success" data-toggle="modal" data-target="#add_note_Modal" type="button"><i class="fa fa-edit"></i></button>
