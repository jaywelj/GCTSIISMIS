								...
								<div class="tab-pane active" role="tabpanel" id="step1">
									...
									<div class="form-horizontal form-label-left">
										...
										<div class="form-group">
											...
											<label class="control-label col-md-1 col-sm-1" for="first-name">Others: <span ></span>
											</label>
											<div class="col-md-3 col-sm-3">
								...
								<div class="tab-pane" role="tabpanel" id="step2">
									...
									<div class="form-horizontal form-label-left">
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input type="text" id="first-name2" class="form-control col-md-7 col-xs-12">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input type="text" id="last-name2" name="last-name" class="form-control col-md-7 col-xs-12">
											</div>
										</div>
										<div class="form-group">
								...
								<div class="tab-pane" role="tabpanel" id="step3">
									...
									<div class="form-horizontal form-label-left">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-3">
												<input type="text" id="first-name2" class="form-control col-md-7 col-xs-12" disabled="true">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12">Educational Attainment</label>
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-3">
												<input type="text" id="first-name2" class="form-control col-md-7 col-xs-12" value="Business Woman">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3" for="first-name">Name of Employer <span class="required">*</span>
										...
										<div class="form-group">
											...
											<div class="col-md-1 col-sm-1">
												<input id="middle-name2" class="form-control col-md-1 col-xs-1" type="text" name="middle-name" disabled="true">
											</div>
								...
								<div class="tab-pane" role="tabpanel" id="step4">
									...
									<div class="form-horizontal form-label-left">
										...
										<div class="form-group">
											...
											<div style="margin-left:-10px;" class="col-md-4 col-sm-4">
												<input type="date" id="first-name2" class="form-control col-md-7 col-xs-12">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6">
												<textarea id="message" class="form-control" name="message" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="150" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
