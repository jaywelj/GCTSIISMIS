...
{	
	...
	$querySelectingCollege = "SELECT * FROM tbl_course WHERE `courseCode` = '$VarcharStudentCourse'";
	...
	$VarcharStudentFatherOccupationType = mysqli_real_escape_string($connect, $_POST['dropdownStudentFatherOccupationType']);
	...
	$VarcharStudentMotherOccupationType = mysqli_real_escape_string($connect, $_POST['dropdownStudentMotherOccupationType']);
	...
	$VarcharStudentGuardianOccupationType = mysqli_real_escape_string($connect, $_POST['dropdownStudentGuardianOccupationType']);
	...
	if ($VarcharStudentPsychiatristConsult == "None") {
	...
	if ($VarcharStudentPsychologistConsult == "None") {
	...
	if ($VarcharStudentCounselorConsult == "None") {
	...
	$VarcharStudentTestDateInitial = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestResultDateInitial']);
	$VarcharStudentTestNameInitial = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestResultNameInitial']);
	$VarcharStudentTestRSInitial = mysqli_real_escape_string($connect, $_POST['txtbxStudentRSInitial']);
	$VarcharStudentTestPRInitial = mysqli_real_escape_string($connect, $_POST['txtbxStudentPRInitial']);
	$VarcharStudentTestDescriptionInitial = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestDescriptionInitial']);



					//end of part 6 form wizard
	...
	// {  
	// 	$VarcharClub .= $VarcharStudentClubDB . "/";  
	// }  


	if(isset($_POST['checkStudentClubNoInterest']))
	{
		$VarcharClub = "No Interest";
	}
	else
	{
		if(isset($_POST['checkStudentClub']))
		{
			$VarcharStudentClubArray = $_POST['checkStudentClub'];
			$n = count($VarcharStudentClubArray);
			for ($i=0; $i<$n-1; $i++) { 
				$VarcharClub = $VarcharStudentClubArray[$i] . "/" . $VarcharClub;
			}
			$varcharClub = $varcharClub. $VarcharStudentClubArray[$n-1];
			if(isset($_POST['checkStudentClubOthers']))
			{
				$varcharClubInterestOthers = mysqli_real_escape_string($connect,$_POST['txtbxStudentClubOthers']);
				$VarcharClub = $VarcharClub . "/" . $varcharClubInterestOthers;
			}
		}
		else
		{
			...
			{
				$varcharClubInterestOthers = mysqli_real_escape_string($connect,$_POST['txtbxStudentClubOthers']);
				$VarcharClub = $varcharClubInterestOthers;
			}
		} 
	}

	if(isset($_POST['checkStudentOrganizationNoInterest']))
	{
		$VarcharOrganization = "No Interest";
	}
	else
	{
		if(isset($_POST['checkStudentOrganization']))
		{
			$VarcharStudentOrganizationArray = mysqli_real_escape_string($connect,$_POST['checkStudentOrganization']);
			$n = count($VarcharStudentOrganizationArray);
			for ($i=0; $i<$n-1; $i++) { 
				$VarcharOrganization = $VarcharStudentOrganizationArray[$i] . "/" . $VarcharOrganization;
			}
			$varcharOrganization = $VarcharOrganization. $varcharClubInterestArray[$n-1];
			if(isset($_POST['checkStudentOrganizationOthers']))
			{
				$varcharOrganizationInterestOthers = mysqli_real_escape_string($connect,$_POST['txtbxOrganizationOthers']);
				$VarcharOrganization = $VarcharOrganization . "/" . $varcharOrganizationInterestOthers;
			}
		}
		else
		{
			if(isset($_POST['checkStudentOrganizationOthers']))
			{
				$varcharOrganizationInterestOthers = mysqli_real_escape_string($connect, $_POST['txtbxStudentClubOthers']);
				$VarcharOrganization = $varcharOrganizationInterestOthers;
			}
		} 
	}
	...
	{ 
		...
		$queryAddPersonalInfo = "UPDATE `tbl_personalinfo` SET `lastName` = '$VarcharStudentLastName', `firstName` = '$VarcharStudentFirstName', `middleName` = '$VarcharStudentMiddleName', `sex` = '$VarcharStudentGender', `sexuality` = '$VarcharStudentSexuality', `age` = '$VarcharStudentAge', `year` = '$VarcharStudentYear', `civilStatus` = '$VarcharStudentCivilStatus', `birthDate` = '$VarcharStudentBirthdate', `height` = '$VarcharStudentHeight', `weight` = '$VarcharStudentWeight', `complexion` = '$VarcharStudentComplexion', `birthPlace` = '$VarcharStudentBirthplace', `cityHouseNumber` = '$VarcharStudentCityHouseNumber', `cityProvince` = '$VarcharStudentCityProvince', `cityName` = '$VarcharStudentCityCity', `cityBarangay` = '$VarcharStudentCityBarangay', `provinceHouseNumber` = '$VarcharStudentProvinceHouseNumber', `provinceProvincial` = '$VarcharStudentProvinceProvince', `provinceName` = '$VarcharStudentProvinceCity', `provinceBarangay` = '$VarcharStudentProvinceBarangay', `telNumber` = '$VarcharStudentTelNum', `mobileNumber` = '$VarcharStudentMobileNum', `email` = '$VarcharStudentEmail', `hsGWA` = '$VarcharStudentHSGWA', `religion` = '$VarcharStudentReligion', `employerName` = '$VarcharStudentNameOfEmployer', `employerAddress` = '$VarcharStudentEmployerAddress', `contactPersonName` = '$VarcharStudentContactPersonName', `cpAddress` = '$VarcharStudentContactPersonAddress', `cpRelationship` = '$VarcharStudentContactPersonRelationship', `cpContactNumber` = '$VarcharStudentContactPersonContactNumber', `collegeCode` = '$VarcharStudentCollege', `courseCode` = '$VarcharStudentCourse' WHERE `tbl_personalinfo`.`studentNumber` = '$VarcharStudentNumber'";
		...
		else
		{
			...
			echo "<script type='text/javascript'>location.href = 'IIRNewSignUp.php';</script>";
		}
		...
		if (mysqli_query($connect, $queryAddTestResultsInitial)) {
			//$message = "Successfully Added In Initial Test Results ";
			$VarcharStudentTestName = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestResultName']);
			$message = $VarcharStudentTestName[1];
			echo "<script type='text/javascript'>alert('$message');</script>";
		...
		// $CountingSizeOfArray = count($VarcharStudentTestName);

		// if (
			// !empty($_POST['txtbxStudentTestResultDate']) && !empty($_POST['txtbxStudentTestResultName']) && !empty($_POST['txtbxStudentRS']) && !empty($_POST['txtbxStudentPR']) &&  !empty($_POST['txtbxStudentTestDescription']) &&
			
			// is_array($_POST['txtbxStudentTestResultDate']) && is_array($_POST['txtbxStudentTestResultName']) && is_array($_POST['txtbxStudentRS']) && is_array($_POST['txtbxStudentPR']) && is_array($_POST['txtbxStudentTestDescription'])
		// ) 
		// {
			$VarcharStudentTestDate = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestResultDate']);
			$VarcharStudentTestName = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestResultName']);
			$VarcharStudentTestRS = mysqli_real_escape_string($connect, $_POST['txtbxStudentRS']);
			$VarcharStudentTestPR = mysqli_real_escape_string($connect, $_POST['txtbxStudentPR']);
			$VarcharStudentTestDescription = mysqli_real_escape_string($connect, $_POST['txtbxStudentTestDescription']);

			for ($i=1; $i < count($VarcharStudentTestName) ; $i++) 
			{ 
				$TestDate = mysqli_real_escape_string($VarcharStudentTestDate[$i]);
				$TestName = mysqli_real_escape_string($VarcharStudentTestName[$i]);
				$TestRS = mysqli_real_escape_string($VarcharStudentTestRS[$i]);
				$TestPR = mysqli_real_escape_string($VarcharStudentTestPR[$i]);
				$TestDescription = mysqli_real_escape_string($VarcharStudentTestDescription[$i]);
				$TestStudentNumber = $VarcharStudentNumber;

				$queryAddingNewTestResults = "INSERT INTO `tbl_testrecord` (`testID`, `testDate`, `testName`, `testRawScore`, `testPercentile`, `testDescription`, `studentNumber`) VALUES (NULL, '$TestDate', '$TestName', '$TestRS', '$TestPR', '$TestDescription', '$TestStudentNumber')";
				mysqli_query($connect, $queryAddingNewTestResults);
			}
		// }
						...
						<div class="card wizard-card" data-color="red" id="wizard">
							<form action="IIRNewSignUp.php" method="post" enctype="multipart/form-data">
								...
								{  
									...
									$VarcharStudentNumberFromDB = $row['studentNumber'];
								...
								$queryCourse = "SELECT * FROM tbl_course WHERE courseCode = '$VarcharStudentCourseCode'";
										...
										<div class="row">
											...
											<div class="col-sm-5 col-sm-offset-1">
												...
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" id="cityaddress" name="txtbxStudentCityProvince">
												</div>
											...
											<div class="col-sm-5">
												...
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" id="txtbxStudentContactPersonRelationship" name="txtbxStudentContactPersonRelationship">
												</div>
									...
									<div class="tab-pane" id="homeandfamilybackground">
										...
										<div class="row">
		                                    ...
		                                    <div class="col-sm-5">
		                                        ...
		                                        <div class="form-group label-floating">
		                                        	<label class="control-label">Parent's Average Monthly Income:</label>
		                                        	<select name="dropdownStudentTotallyMonthlyIncome" class="form-control">
		                                        		<option disabled="" selected=""></option>
		                                        		<option value="Below Average">Below Average</option>
		                                        		<option value="Average">Average</option>
		                                        		<option value="Above Average">Average</option>
		                                        	</select>
		                                        </div>
            								...
            								<div class="col-sm-5 col-sm-offset-1">
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons"> 
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentVision" id="radioStudentVision" autocomplete="off" value="None"><span class="label-text">No</span>
            											</label>
            										</div>
            									</div>
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons">
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentHearing" id="radioStudentHearing" autocomplete="off" value="None"><span class="label-text">No</span>
            											</label>
            										</div>
            									</div>
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons">
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentSpeech" id="radioStudentSpeech" autocomplete="off" value="None"><span class="label-text">No</span>
            											</label>
            										</div>
            									</div>
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons">
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentGeneralHealth" id="radioStudentGeneralHealth" autocomplete="off" value="None"><span class="label-text">No</span>
            											</label>
            										</div>
            									</div>
            								...
            								<div class="col-sm-5">
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons">
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentPsychiatrist" id="radioStudentPsychiatrist" autocomplete="off" value="None"><span class="label-text">None</span>
            											</label>
            										</div>
            									</div>
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons">
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentPsychologist" id="radioStudentPsychologist" autocomplete="off" value="None"><span class="label-text">None</span>
            											</label>
            										</div>
            									</div>
            									...
            									<div class="form-group label-floating" form-check" data-toggle="buttons">
            										...
            										<div class="btn-group btn-group-toggle" data-toggle="buttons">
            											...
            											<label class="btn btn-primary">
            												<input type="radio" name="radioStudentCounselor" id="radioStudentCounselor" autocomplete="off" value="None"><span class="label-text">None</span>
            											</label>
            										</div>
            									</div>
            								...
            								<div class="col-sm-12">
            									...
            									<div class="oldTestFields">
            										...
            										<div class="form-group label-floating">
            											...
            											<input type="date" name="txtbxStudentTestResultDateInitial">
            										</div>

            										<div class="form-group label-floating">
            											<label class="control-label">Name</label>
            											<div class="input-group">
            												<input type="text" class="form-control" name="txtbxStudentTestResultNameInitial">
            											</div>
            										</div>
            										...
            										<div class="form-group label-floating">
            											...
            											<div class="input-group">
            												<input type="text" class="form-control" name="txtbxStudentRSInitial">
            										...
            										<div class="form-group label-floating">
            											...
            											<div class="input-group">
            												<input type="text" class="form-control" name="txtbxStudentPRInitial">
            										...
            										<div class="form-group label-floating">
            											...
            											<div class="input-group">
            												<input type="text" class="form-control" name="txtbxStudentTestDescriptionInitial">
