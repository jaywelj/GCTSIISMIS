                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="wizard-container">
                        <div class="card wizard-card" data-color="red" id="wizard">
                            <form action="IIR.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="dropdownStudentComplexion" id="dropdownStudentComplexion">
                                                        ...
                                                        <option><?php echo $varcharStudentComplexion; ?></option>
                                                        <option selected="" value="White Skin">White Skin</option>
                                                ...
                                                <?php 
                                                include("connectionString.php");
                                                $queryCourseGetting = "SELECT * FROM tbl_course WHERE courseCode = '$varcharStudentCourse'";
                                                $resultCourseGetting = mysqli_query($connect, $queryCourseGetting);

                                                while ($tempres = mysqli_fetch_array($resultCourseGetting)) {
                                                    $TemporaryCourseCode = $tempres['courseCode'];
                                                    $TemporaryCourseName = $tempres['courseName'];
                                                }
                                                ...
                                                <!-- <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownStudentCollege" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentCollege; ?></option>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownStudentCourse" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected="" value="<?php echo $TemporaryCourseCode;?>"><?php echo $TemporaryCourseCode;?> - <?php echo $TemporaryCourseName;?></option>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <div class="btn-group btn-group-toggle form-check" data-toggle="buttons">
                                                        ...
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioGender" id="radioGender" autocomplete="off" value="M" <?php echo ($varcharStudentSexFull == 'Male')?'checked':'' ?>><span class="label-text">♂Male</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioGender" id="radioGender" autocomplete="off" value="F" <?php echo ($varcharStudentSexFull == 'Female')?'checked':'' ?> ><span class="label-text">♀Female</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="dropdownStudentSexuality" id="dropdownStudentSexuality">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentSexuality; ?></option>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="dropdownStudentCivilStatus" id="dropdownStudentCivilStatus">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentCivilStatus; ?></option>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="email" class="form-control" id="emailaddress" name="txtbxStudentEmail" value="<?php echo $varcharStudentEmail; ?>">
                                                </div>
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" id="cityaddress" name="txtbxStudentCityProvince" value="<?php echo $varcharStudentCityProvince; ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" id="provincialaddress" name="txtbxStudentProvincialHouseNumber" value="<?php echo $varcharStudentProvinceHouseNumber; ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="dropdownStudentReligion" id="dropdownStudentReligion">
                                                        <option disabled=""></option>
                                                        <option selected=""> <?php echo $varcharStudentReligion; ?> </option>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" id="txtbxStudentNameOfEmployer" name="txtbxStudentNameOfEmployer" value="<?php echo $varcharStudentEmployerName ?>">
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">Address Of Employer</label>
                                                    <input type="text" class="form-control" id="txtbxStudentAddressoFEmployer" name="txtbxStudentAddressoFEmployer" value="<?php echo $varcharStudentEmployerAddress; ?>">
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">Contact Person Name</label>
                                                    <input type="text" class="form-control" id="txtbxStudentContactPersonName" name="txtbxStudentContactPersonName" value="<?php echo $varcharStudentContactPersonName; ?>">
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">Contact Person Address</label>
                                                    <input type="text" class="form-control" id="txtbxStudentContactPersonAddress" name="txtbxStudentContactPersonAddress" value="<?php echo $varcharStudentContactPersonAdress ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownstudentContactPersonRelation" id="dropdownstudentContactPersonRelation" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentContactPersonRelationship ; ?></option>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" id="txtbxStudentContactPersonContactNumber" name="txtbxStudentContactPersonContactNumber" value="<?php echo $varcharStudentContactPersonContactNumber ?>">
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5 col-sm-offset-1">
                                                    ...
                                                    <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                        ...
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <br>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioPrepType" id="radioPrepType" autocomplete="off" value="Public" <?php echo ($varcharStudentPreSchoolType =='Public')?'checked':'' ?>><span class="label-text">Public</span>
                                                            </label>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioPrepType" id="radioPrepType" autocomplete="off" value="Private" <?php echo ($varcharStudentPreSchoolType =='Private')?'checked':'' ?>><span class="label-text">Private</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="number" class="form-control" id="txtbxStudentPre-ElemNumOfAttendance" name="txtbxStudentPre-ElemNumOfAttendance1" value="<?php echo $varcharStudentPreSchoolYearAttended1; ?>">
                                                        <!--<span class="input-group-addon">From Year</span>-->
                                                    </div>
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">To Year</label>
                                                        <input type="number" class="form-control" id="txtbxStudentPre-ElemNumOfAttendance" name="txtbxStudentPre-ElemNumOfAttendance2" value="<?php echo $varcharStudentPreSchoolYearAttended2; ?>">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                        ...
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <br>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioElemType" id="radioElemType" autocomplete="off" value="Public" <?php echo ($varcharStudentElementarySchoolType =='Public')?'checked':'' ?>><span class="label-text">Public</span>
                                                            </label>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioElemType" id="radioElemType" autocomplete="off" value="Private" <?php echo ($varcharStudentElementarySchoolType =='Private')?'checked':'' ?>><span class="label-text">Private</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">From Year</label>
                                                        <input type="number" class="form-control" id="elemnumofattendance" name="txtbxStudentElemNumOfAttendance1" value="<?php echo $varcharStudentElementarySchoolYearAttended1; ?>">
                                                    </div>

                                                    <div class="form-group label-floating">
                                                        <label class="control-label">To Year</label>
                                                        <input type="number" class="form-control" id="elemnumofattendance" name="txtbxStudentElemNumOfAttendance2" value="<?php echo $varcharStudentElementarySchoolYearAttended2; ?>">
                                                    </div>


                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Honors Received/Special Awards</label>
                                                        <input type="text" class="form-control" id="elemhonors" name="txtbxStudentElemHonors" value="<?php echo $varcharStudentElementarySchoolAwards; ?>">
                                                    </div>
                                                </div>
                                                <!--Lower Left-->
                                                <div class="col-sm-5 col-sm-offset-1">
                                                    ...
                                                    <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                        ...
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <br>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioHSType" id="radioHSType" autocomplete="off" value="Public" <?php echo ($varcharStudentHSSchoolType =='Public')?'checked':'' ?>><span class="label-text">Public</span>
                                                            </label>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioHSType" id="radioHSType" autocomplete="off" value="Private" <?php echo ($varcharStudentHSSchoolType =='Private')?'checked':'' ?>><span class="label-text">Private</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">From Year</label>
                                                        <input type="number" class="form-control" id="hsnumofattendance" name="txtbxStudentHSNumOfAttendance1" value="<?php echo $varcharStudentHSSchoolYearAttended1; ?>">
                                                    </div>
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">To Year</label>
                                                        <input type="number" class="form-control" id="hsnumofattendance" name="txtbxStudentHSNumOfAttendance2" value="<?php echo $varcharStudentHSSchoolYearAttended2; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                        ...
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <br>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioCollegeType" id="radioCollegeType" autocomplete="off" value="Public" <?php echo ($varcharStudentCollegeSchoolType =='Public')?'checked':'' ?>><span class="label-text">Public</span>
                                                            </label>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioCollegeType" id="radioCollegeType" autocomplete="off" value="Private" <?php echo ($varcharStudentCollegeSchoolType =='Private')?'checked':'' ?>><span class="label-text">Private</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">From Year</label>
                                                        <input type="number" class="form-control" id="collegenumofattendance" name="txtbxStudentCollegeNumofAttendance1" value="<?php echo $varcharStudentCollegeSchoolYearAttended1; ?>">
                                                    </div>
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">To Year</label>
                                                        <input type="number" class="form-control" id="collegenumofattendance" name="txtbxStudentCollegeNumofAttendance2" value="<?php echo $varcharStudentCollegeSchoolYearAttended2; ?>">
                                                    </div>
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">School Graduated</label>
                                                        <input type="text" class="form-control" id="vocationalgrad" name="txtbxStudentVocationalGrad" value="<?php echo $varcharStudentVocationalSchoolName; ?>">
                                                    </div>
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">School Address</label>
                                                        <input type="text" class="form-control" id="vocationaladdress" name="txtbxStudentVocationalAddress" value="<?php echo $varcharStudentVocationalSchoolAddress; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                        ...
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <br>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioVocationalType" id="radioVocationalType" autocomplete="off" value="Public" <?php echo ($varcharStudentVocationalSchoolType =='Public')?'checked':'' ?>><span class="label-text">Public</span>
                                                            </label>
                                                            <label class="btn btn-primary">
                                                                <input type="radio" name="radioVocationalType" id="radioVocationalType" autocomplete="off" value="Private" <?php echo ($varcharStudentVocationalSchoolType =='Private')?'checked':'' ?>><span class="label-text">Private</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Honors Received/Special Awards</label>
                                                        <input type="text" class="form-control" id="collegehonors" name="txtbxStudentCollegeHonors" value="<?php $varcharStudentCollegeSchoolAwards; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <select name="dropdownStudentNatureOfSchooling" id="dropdownStudentNatureOfSchooling" class="form-control">
                                                            <option disabled=""></option>
                                                            <option><?php echo $varcharStudentNatureOfSchooling; ?></option>
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownStudentFatherEducationalAttainment" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentFatherEducation; ?></option>
                                                ...
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <br>
                                                    <label class="btn btn-primary">
                                                        <input type="radio" name="radioStudentFatherStatus" id="radioStudentFatherStatus" autocomplete="off" value="Living" <?php echo ($varcharStudentFatherStatus =='Living')?'checked':'' ?>><span class="label-text">Living</span>
                                                    </label>
                                                    <label class="btn btn-primary">
                                                        <input type="radio" name="radioStudentFatherStatus" id="radioStudentFatherStatus" autocomplete="off" value="Deceased" <?php echo ($varcharStudentFatherStatus =='Deceased')?'checked':'' ?>><span class="label-text">Deceased</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownStudentFatherOccupationType" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentFatherOccupationType; ?></option>
                                                        <optgroup>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownStudentMotherEducationalAttainment" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentMotherEducation; ?></option>
                                                        <option value="Elementary Undergraduate">Elementary Undergraduate</option>
                                                        <option value="Elementary Graduate">Elementary graduate</option>
                                                        <option value="High School Undergraduate">High School Undergraduate</option>
                                                        <option value="High School Graduate">High School Graduate</option>
                                                ...
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <br>
                                                    <label class="btn btn-primary">
                                                        <input type="radio" name="radioStudentMotherStatus" id="radioStudentMotherStatus" autocomplete="off" value="Living" <?php echo ($varcharStudentMotherStatus =='Living')?'checked':'' ?>><span class="label-text">Living</span>
                                                    </label>
                                                    <label class="btn btn-primary">
                                                        <input type="radio" name="radioStudentMotherStatus" id="radioStudentMotherStatus" autocomplete="off" value="Deceased" <?php echo ($varcharStudentMotherStatus =='Deceased')?'checked':'' ?>><span class="label-text">Deceased</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="dropdownStudentParentMaritalRelationship" id="dropdownStudentParentMaritalRelationship" class="form-control">
                                                        <option disabled=""></option>
                                                        <option selected=""><?php echo $varcharStudentMaritalRelationship; ?></option>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" id="txtbxStudentNumOfChildren" name="txtbxStudentNumOfChildren" value="<?php echo $varcharStudentNumOfChildren; ?>">
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">Number Of Brother/s </label>
                                                    <input type="text" class="form-control" id="txtbxStudentNumOfBrothers" name="txtbxStudentNumOfBrothers" disabled="true" value="<?php echo $varcharStudentNumOfBrother; ?>" >
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">Number Of Sister/s </label>
                                                    <input type="text" class="form-control" id="txtbxStudentNumOfSisters" name="txtbxStudentNumOfSisters" disabled="true" value="<?php echo $varcharStudentNumOfSister; ?>">
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">Number Of siblings gainfully employed </label>
                                                    <input type="text" class="form-control" id="txtbxStudentNumOfSiblingsEmployed" name="txtbxStudentNumOfSiblingsEmployed" disabled="true" value="<?php echo $varcharStudentSiblingsEmployed ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="dropdownStudentFinancer" id="dropdownStudentFinancer">
                                                        <option disabled=""></option>
                                                        <option><?php echo $varcharStudentSchoolFinancer; ?></option>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentQuietPlace" id="radioStudentQuietPlace" autocomplete="off" value="Yes" <?php echo ($varcharStudentStudyPlace =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentQuietPlace" id="radioStudentQuietPlace" autocomplete="off" value="No" <?php echo ($varcharStudentStudyPlace =='No')?'checked':'' ?>><span class="label-text">No</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentShareRoom" id="radioStudentShareRoom" autocomplete="off" value="Yes" <?php echo ($varcharStudentRoomSharing =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentShareRoom" id="radioStudentShareRoom" autocomplete="off" value="No" <?php echo ($varcharStudentRoomSharing =='No')?'checked':'' ?>><span class="label-text">No</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons"> 
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentVision" id="radioStudentVision" autocomplete="off" value="Yes" <?php echo ($varcharStudentVisionProblem =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentVision" id="radioStudentVision" autocomplete="off" value="None" <?php echo ($varcharStudentVisionProblem =='None')?'checked':'' ?>><span class="label-text">None</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentHearing" id="radioStudentHearing" autocomplete="off" value="Yes" <?php echo ($varcharStudentHearingProblem == 'Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentHearing" id="radioStudentHearing" autocomplete="off" value="None" <?php echo ($varcharStudentHearingProblem =='None')?'checked':'' ?>><span class="label-text">None</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentSpeech" id="radioStudentSpeech" autocomplete="off" value="Yes" <?php echo ($varcharStudentSpeechProblem =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentSpeech" id="radioStudentSpeech" autocomplete="off" value="None" <?php echo ($varcharStudentSpeechProblem =='None')?'checked':'' ?>><span class="label-text">None</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentGeneralHealth" id="radioStudentGeneralHealth" autocomplete="off" value="Yes" <?php echo ($varcharStudentGeneralHealth =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentGeneralHealth" id="radioStudentGeneralHealth" autocomplete="off" value="None" <?php echo ($varcharStudentGeneralHealth =='None')?'checked':'' ?>><span class="label-text">None</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentPsychiatrist" id="radioStudentPsychiatrist" autocomplete="off" value="Yes" <?php echo ($varcharStudentPsychiatristConsult =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentPsychiatrist" id="radioStudentPsychiatrist" autocomplete="off" value="Never" <?php echo ($varcharStudentPsychiatristConsult =='Never')?'checked':'' ?>><span class="label-text">Never</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    <input type = "date" id="txtbxStudentPsychiatristWhen"name="txtbxStudentPsychiatristWhen" disabled="true" value="<?php echo $varcharStudentPsychiatristWhen; ?>">
                                                </div>

                                                <div class="form-group label-floating">
                                                    <label class="control-label">For What?</label>
                                                    <input type="textarea" class="form-control" id="txtbxStudentPsychiatristWhat" name="txtbxStudentPsychiatristWhat" disabled="true" value=" <?php echo $varcharStudentPsychiatristReason ?> " >
                                                </div>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentPsychologist" id="radioStudentPsychologist" autocomplete="off" value="Yes" <?php echo ($varcharStudentPsychologistConsult =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentPsychologist" id="radioStudentPsychologist" autocomplete="off" value="Never" <?php echo ($varcharStudentPsychologistConsult =='Never')?'checked':'' ?>><span class="label-text">Never</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    <input type = "date" id="txtbxStudentPsychologistWhen" name="txtbxStudentPsychologistWhen" disabled="true" value="<?php echo $varcharStudentPsychologistWhen; ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">For What?</label>
                                                    <input type="textarea" class="form-control" id="txtbxStudentPsychologistWhat" name="txtbxStudentPsychologistWhat" disabled="true" value="<?php echo $varcharStudentPsychologistReason; ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating" form-check" data-toggle="buttons">
                                                    ...
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <br>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentCounselor" id="radioStudentCounselor" autocomplete="off" value="Yes" <?php echo ($varcharStudentCounselorConsult =='Yes')?'checked':'' ?>><span class="label-text">Yes</span>
                                                        </label>
                                                        <label class="btn btn-primary">
                                                            <input type="radio" name="radioStudentCounselor" id="radioStudentCounselor" autocomplete="off" value="Never" <?php echo ($varcharStudentCounselorConsult =='Never')?'checked':'' ?>><span class="label-text">Never</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    <input type = "date" id="txtbxStudentCounselorWhen"name="txtbxStudentCounselorWhen" disabled="true" value="<?php echo $varcharStudentCounselorWhen; ?>">
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">For What?</label>
                                                    <input type="textarea" class="form-control" id="txtbxStudentCounselorWhat" name="txtbxStudentCounselorWhat" disabled="true" value="<?php echo $varcharStudentCounselorReason; ?>">
                                                </div>
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestMath" value="Math club" <?php if(in_array("Math Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Math Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestScience" value="Science club"<?php if(in_array("Science Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Science Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestEnglish" value="English club"<?php if(in_array("English Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">English Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestFilipino" value="Filipino club" <?php if(in_array("Filipino Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Filipino Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestAstronomy" value="Astronomy club" <?php if(in_array("Astronomy Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Astronomy Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestDebating" value="Debating club" <?php if(in_array("Debating Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Debating Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestQuizzer" value="Quizzers Club" <?php if(in_array("Quizzers Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>><span class="label-text">Quizzer's Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestSocialStudies" value="Social Studies Club" <?php if(in_array("Social Studies Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Social Studies Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkClubInterest[]" id="checkClubInterestStatistics" value="Statistics Club" <?php if(in_array("Statistics Club",$varcharStudentClubNameArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Statistics Club</span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label>
                                                    ...
                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkOrganizationInterest[]" id="checkOrganizationInterestAthletics" value="Athletics" <?php if(in_array("Athletics",$varcharStudentInterestOrganizationArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Athletics</span>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkOrganizationInterest[]" id="checkOrganizationInterestDramatics" value="Dramatics" <?php if(in_array("Dramatics",$varcharStudentInterestOrganizationArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Dramatics</span>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkOrganizationInterest[]" id="checkOrganizationInterestReligion" value="Religious Organization" <?php if(in_array("Religious Organization",$varcharStudentInterestOrganizationArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Religious Organization</span>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkOrganizationInterest[]" id="checkOrganizationInterestGlee" value="Glee Club" <?php if(in_array("Glee Club",$varcharStudentInterestOrganizationArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Glee Club</span>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkOrganizationInterest[]" id="checkOrganizationInterestScouting" value="Scouting" <?php if(in_array("Scouting",$varcharStudentInterestOrganizationArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Scouting</span>
                                                        </label>
                                                    </div>

                                                    <div class="form-check">
                                                        <label>
                                                            <input type="checkbox" name="checkOrganizationInterest[]" id="checkOrganizationInterestChess" value="Chess Club" <?php if(in_array("Chess Club",$varcharStudentInterestOrganizationArray)) { ?> checked="checked" <?php } ?>> <span class="label-text">Chess 
                                                            club</span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="txtbxOrganizationPosition" id="txtbxOrganizationPosition" value="<?php echo $varcharStudentOrganizationPosition; ?>">
                                                            <span class="input-group-addon">Please Specify</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="oldTestFields">
                                                    <h3 class="info-text"> Test Result '.$i.' </h3>
                                                    <div class="form-group label-floating">
                                                        <h4 class="info-text"> Date </h4>
                                                        <input type="date" name="dateTestResultDateInitial[]" value="'.$resu['testDate'].'">
                                                    </div>

                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Name</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="txtbxTestResultNameInitial[]" value="'.$resu['testName'].'">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="txtbxTestResultRawScoreInitial[]" value="'.$resu['testRawScore'].'">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="txtbxTestResultPercentileRatingInitial" value="'.$resu['testPercentile'].'">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="txtareaTestResultDescriptionInitial" value="'.$resu['testDescription'].'">
