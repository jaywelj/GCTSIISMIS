...
<html lang="en">
  ...
  <body class="login">
      ...
      <div class="login_wrapper">
        ...
        // for method 1/
                ...
                if(isset($_POST['btnAdd'])) 
                {
                    ...
                    $VarcharStudentAccountCollege = mysqli_real_escape_string($connect, $_POST['dropdownStudentAccountCollege']);

                    $queryGettingCollege = "SELECT * FROM tbl_college WHERE `courseCode` =  '$VarcharStudentAccountCourse'";
                    $resultGettingCollege = mysqli_query($connect, $queryGettingCollege);
                    $res = mysqli_fetch_array($resultGettingCollege)
                    {
                      $VarcharStudentAccountCollege = $res['collegeCode'];
                      $VarcharStudentAccoungCollegeName = $res['collegeName'];
    ...
    function showCheck() 
    {
      var x = document.getElementById("txtbxStudentAccountPassword");
      if (x.type === "password") 
      {
          x.type = "text";
      } else 
