        ...
        <h4 style="margin-top: 0; font-weight: bold;">GUIDANCE COUNCIL AND TESTING SERVICES</h4>
                                     ...
                                     <div id="nav_wrapper">
                                         <ul>
                                           ...
                                           <li class="page-scroll active"><span class="submenu-button submenu-opened"></span><a href="clientHome.php"><span> Home</span></a>
                                            </li>
                                           <li class="page-scroll"><a class="profile" href="clientProfile.php"><span>Profile </span></a></li>
                                           <li class="page-scroll"><a href="IIR.php?id=<?php echo$varcharStudentAccountNumber ?>"><span>Individual Inventory Report</span></a></li>
