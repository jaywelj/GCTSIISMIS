...
?>
                                  ...
                                  while($res = mysqli_fetch_array($result))
                                    ...
                                    $varcharStudentCover = $res['studentCoverPhoto'];
                                   }
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                          ...
                          <tr>  
                               <td>  
                                    ...
                                    <input type="file" id="file-input" name="image" accept="image/*" capture style="display:none"/>
                     ...
                     ';  
                              ...
                              <div class="col-md-9 col-sm-9 os-animation">
                                ...
                                <p><span>City Address :  </span>  <?php echo $varcharStudentMobileNum; ?> </p>
                                <p><span>Provincial Address :  </span>  <?php echo $varcharStudentMobileNum; ?> </p>
                                ...
                                $resultTest = mysqli_query($connect, "SELECT * FROM `tbl_testrecord` WHERE studentNumber = '$varcharStudentAccountNumber' ORDER BY `testID` DESC");
                                   ...
                                   while($resTest = mysqli_fetch_array($resultTest)){
                                    ?>
                                        ...
                                        <h3> <?php echo $resTest['testName']; ?> </h3>
                                    </div>
                                </div>
                                    ...
                                    <div class="gray_section">
                                    <p><span>Date :  </span> <?php echo  $resTest['testDate']; ?></p>
                                    <p><span>RS :  </span><?php echo $resTest['testRawScore']; ?>   </p>
                                    <p><span>PR :  </span> <?php echo $resTest['testPercentile']; ?></p>
                                    </div>
                                </div>
                                <div class='clearfix'></div>
