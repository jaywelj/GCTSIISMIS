...
if(isset($VarcharStudentNumber))
{
	...
	else
	{
		...
		echo "<script type='text/javascript'>location.href = 'individualInventory.php?id=$VarcharStudentNumber';</script>";
	}
