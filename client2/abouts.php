...
<body>
	...
	<div class="container">
		<div class="row">
			<ul class="nav flex-column col-lg-3 pull-right" style="margin-top: 30px;">
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse1" role="button" aria-expanded="false" aria-controls="collapse1">Guidance, Counselling, and Testing Services</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse2" role="button" aria-expanded="false" aria-controls="collapse2">Vision, Mission and Objectives</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapse3">History</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse4" role="button" aria-expanded="false" aria-controls="collapse4">Services</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse5" role="button" aria-expanded="false" aria-controls="collapse5">Facilities</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse6" role="button" aria-expanded="false" aria-controls="collapse6">Officials and staffs</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapse7" role="button" aria-expanded="false" aria-controls="collapse7">Contact Information</a>
				</li>
			</ul>
			<div class="fea collapse in multi-colapse col-lg-9 " id="collapse1">
				<div class="">
			...
			<div class="fea collapse col-lg-9 " id="collapse2">
				<div class="">
					<div class="heading pull-right">
						<h4>Vision</h4>
			...
			<div class="fea collapse col-lg-9 " id="collapse3">
				<div class="">
					<div class="heading pull-right">
						<h4>History</h4>
						<p>
			...
			<div class="fea collapse col-lg-9 " id="collapse4">
				<div class="">
					<div class="heading pull-right">
						<h4>Services</h4>
						<p>
			...
			<div class="fea collapse col-lg-9 " id="collapse5">
				<div class="">
					<div class="heading pull-right">
						<h4>Guidance, Counselling, and Testing Services</h4>
						<p>Guidance is a vital part of education that provides assistance to students so that they would make intelligent decisions and adjustment in life. Its fundamental aim is to assist in bringing-out the best in a person – to help him responsibly adjust to situations as he progresses.<br><br>
			...
			<div class="fea collapse col-lg-9 " id="collapse6">
				<div class="">
					<div class="heading pull-right">
						<p><h4>Officials and Staff</h4>
							<table>
								<tr>
									<td>
										<img alt="Barbara P. Camacho" src="../../resources/images/people/employees/camachobp.jpg" style="width: 150px; height: 200px">
									</td>
									<td>
										<p>
											<strong>Barbara P. 
				...
				<div class="fea collapse col-lg-9 " id="collapse7">
					<div class="">
						<div class="heading pull-right">
